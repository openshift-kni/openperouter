...
sed -i "s|openperouter/openperouter/.*/config/all-in-one/openpe.yaml|openperouter/openperouter/v$OPENPE_VERSION/config/all-in-one/openpe.yaml|g" website/content/docs/installation/_index.md
sed -i "s|openperouter/openperouter/.*/config/all-in-one/crio.yaml|openperouter/openperouter/v$OPENPE_VERSION/config/all-in-one/crio.yaml|g" website/content/docs/installation/_index.md
sed -i "s|github.com/openperouter/openperouter/config/default?ref=.*|github.com/openperouter/openperouter/config/default?ref=v$OPENPE_VERSION|g" website/content/docs/installation/_index.md
sed -i "s|github.com/openperouter/openperouter/config/crio?ref=.*|github.com/openperouter/openperouter/config/crio?ref=v$OPENPE_VERSION|g" website/content/docs/installation/_index.md
