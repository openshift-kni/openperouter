...
#### [`quay.io/redhat-user-workloads/telco-5g-tenant/openperouter-operator-5-0`](https://quay.io/repository/redhat-user-workloads/telco-5g-tenant/openperouter-operator-5-0?)
...
- `<revision>`: built from the specifig git revision (main/release branch only)


#### [`quay.io/redhat-user-workloads/telco-5g-tenant/openperouter-operator-bundle-5-0`](https://quay.io/repository/redhat-user-workloads/telco-5g-tenant/openperouter-operator-bundle-5-0)

Operator bundle images that can be installed via [Bundle Deployment](#bundle-deployment) method.
tags:
...
- `test-latest`, `test-<revision>`: operator bundle at latest (or specify) commit.
- `edge-latest`, `edge-<revision>`: operator bundle to deply edge image at latest (or specify) commit.
- `test-pr-<N>`, `test-<revision>`: reference the last operator image build from PR N, or the specified commit. 
- `edge-pr-<N>`, `edge-<revision>`: reference the last operator edge image build from PR N, or the specified commit. 


#### [`quay.io/redhat-user-workloads/telco-5g-tenant/openperouter-operator-edge-5-0`](https://quay.io/repository/redhat-user-workloads/telco-5g-tenant/openperouter-operator-edge-5-0?)
